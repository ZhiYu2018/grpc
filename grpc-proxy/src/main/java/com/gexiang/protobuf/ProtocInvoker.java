...
public class ProtocInvoker {
     ...
     * if none is passed.
     */
    public ProtocInvoker(Path discoveryRoot, ImmutableList<Path> protocIncludePaths) {
     ...
     */
    public DescriptorProtos.FileDescriptorSet invoke() throws ProtocInvocationException {
        ...
        try {
            return DescriptorProtos.FileDescriptorSet.parseFrom(Files.readAllBytes(descriptorPath));
        } catch (IOException e) {
